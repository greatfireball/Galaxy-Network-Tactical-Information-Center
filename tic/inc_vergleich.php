...
$ftyp3[13] = 'Abfanj&auml;ger &quot;Horus&quot;';
	...
	$atter_galas = '';
	for ($n = 0; $n < $SQL_Num; $n++) {
		$a_gala   = mysql_result( $SQL_angreifer, $n, 'angreifer_galaxie');
		$a_planet = mysql_result( $SQL_angreifer, $n, 'angreifer_planet');
...
// DEBUG ende
	...
	for ($n = 0; $n < $SQL_Num; $n++) {
		$d_gala   = mysql_result( $SQL_verteidiger, $n, 'angreifer_galaxie');
		$d_planet = mysql_result( $SQL_verteidiger, $n, 'angreifer_planet');
...
//		$flug[$mode][$flotte][$ftyp1[$cnt]] = mysql_result( $SQL_result, 0, 'sf0'.$ftyp2[$cnt]);
	...
	for ($n = 0; $n < 2-$SQL_Num; $n++) {
		if ( $n < $SQL_Num )
			$fnr = mysql_result( $SQL_rumflieg, $n, 'flottennr');
		else
			$fnr = $n+1;
...
?>
<center>
	<p><font size="4">Gegen&uuml;berstellung Angreifer/Verteidiger</font></p>
	<table border="0" cellspacing="0" cellpadding="0" width="80%" bgcolor="#999999">
		<tr><td>
			<table border="0" cellspacing="3" cellpadding="0" width="100%">
				<tr bgcolor="#333333">
					<td width="50%"><b><font size="-1" color="#FFFFFF">Verteidiger</font></b></td>
					<td><b><font size="-1" color="#FFFFFF">Angreifer</font></b></td>
				</tr>
				<tr bgcolor="#eeeeee">
					<td width="50%"><font size="-1"><?php echo $deffer_galas; ?></font></td>
					<td><font size="-1"><?php echo $atter_galas; ?></font></td>
				</tr>
			</table>
		</td></tr>
	</table>
...
?>
	<br><br>
	<table border="0" cellspacing="0" cellpadding="0" width="80%" bgcolor="#333333"><tr><td><b><font color="#FFFFFF" size="-1">&nbsp;Gesamterfassung aller Flotten</font></b></td></tr><tr><td>
		<table border="0" cellspacing="3" cellpadding="0" width="100%" bgcolor="#999999">
			<tr bgcolor="#333333">
				<td width="50%"><b><font color="#FFFFFF" size="-1">Verteidiger</font></b></td>
				<td><b><font color="#FFFFFF" size="-1">Angreifer</font></b></td>
			</tr>
			<tr>
...
<?   for($cnt = 0; $cnt <= 13; $cnt++){ ?>
						<tr bgcolor="#eeeeee">
							<td width="82%"><font size="-1"><? echo $ftyp3[$cnt] ?></font></td>
							<td width="18%" align="right"><font size="-1"><?php echo $dsum[$cnt]; ?></font></td>
						</tr>
<? } ?>
					</table>
				</td>
...
<?   for($cnt = 0; $cnt <= 8; $cnt++){ ?>
						<tr bgcolor="#eeeeee">
							<td width="82%"><font size="-1"><? echo $ftyp3[$cnt] ?></font></td>
							<td width="18%" align="right"><font size="-1"><?php echo $asum[$cnt]; ?></font></td>
						</tr>
<? } ?>
					</table>
				</td>
...
<?	// füge orbit des deffers hinzu
	...
	if ( $SQL_Num2 > 0 ){
		...
		$ke = mysql_result( $SQL_result, 0, 'ke');
	}
	if($flug[angreifer] != '') {
