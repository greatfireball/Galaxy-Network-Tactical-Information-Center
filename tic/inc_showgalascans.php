...
?>
  ...
  <table width="100%" cellspacing="0" cellpadding="0">
    <tr>
      <td class="datatablehead">Scanausgaben</td>
    </tr>
    <tr>
      <td>
          ...
          <tr class="fieldnormallight">
            <td valign="top" width="30%">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                <tr>
                  <td class="datatablehead" width="25%">Spezieller Planet</td>
                </tr>
                <tr>
                  <td width="25%">Einzelner Planet</td>
                </tr>
                <tr>
                  <td width="25%">Gala:Planet <input type="text" name="xgala" size="4" value="<?=(isset($xgala) ? $xgala : "")?>" /> : <input type="text" name="xplanet" size="2" value="<?=(isset($xplanet) ? $xplanet : "")?>" /></td>
                </tr>
                <tr>
            ...
            <td valign="top" width="30%">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                <tr>
                  <td class="datatablehead" width="25%">Galaxie anzeigen</td>
                </tr>
                <tr>
                  <td width="25%">Nachbar-Galas:</td>
                </tr>
                <tr>
                  <td width="25%">Galaxie:
                    <?php
                    ...
                    echo "'./main.php?modul=showgalascans&amp;action=findgala&amp;displaytype=1&amp;direction=previous&amp;xgala=".(isset($xgala) ? $xgala : "")."'";
                    echo '" />';
                    ?>
                    <input type="text" name="xgala" size="4" value="<?=(isset($xgala) ? $xgala : "")?>" />
                    <?php
                    echo '<input type="button" name="Verweis" value="&gt;&gt;"';
                    echo 'onclick="self.location.href=';
                    echo "'./main.php?modul=showgalascans&amp;action=findgala&amp;displaytype=1&amp;direction=next&amp;xgala=".(isset($xgala) ? $xgala : "")."'";
                    echo '" />';
                    ?>
                  </td>
                </tr>
            ...
            <td valign="top" width="40%">
              ...
              <table width="100%" cellspacing="0" cellpadding="3">
                <tr>
                  <td class="datatablehead">Suche Planeten</td>
                </tr>
                <tr>
                  <td>
                    <select name="qvar">
                      <?php
                        ...
                        {
                            if ( $_GET['qvar']== "pts,0" )
                                $s1opt=' selected="selected"';
                            else if ( $_GET['qvar'] == "sfsu,1" )
                                $s2opt=' selected="selected"';
                            else if ( $_GET['qvar'] == "ga,3" )
                                $s3opt=' selected="selected"';
                            else if ( $_GET['qvar'] == "me,0" )
                                $s4opt=' selected="selected"';
                            else
                                $s5opt=' selected="selected"';
                        }
                      ?>
                    ...
                    <select name="qoperator">
                      <?php
                        $gtopt='';
                        $ltopt='';
                        if ( !isset($_GET['qoperator']) || $_GET['qoperator'] == "<" )
                            $ltopt=' selected="selected"';
                        else
                            $gtopt=' selected="selected"';
                      ?>
                ...
                <tr>
                  <td>Kriterium: <input type="text" name="qval" value="<?php if(isset($_GET['qval'])) echo '"'.$_GET['qval'].'"'; ?>" /></td>
                </tr>
                <tr>
                  <td align="right">(&lt;=10 Treffer) <input type="submit" value="Anzeigen" /></td>
                </tr>
              </table>
              </form>
            </td>
  ...
  <?php
  echo '<form action="./main.php?modul=scans" method="post">';
  echo '<input type="hidden" name="txtScanGalaxie" value="'.(isset($xgala) ? $xgala : "").'" />';
  echo '<input type="hidden" name="txtScanPlanet" value="'.(isset($xplanet) ? $xplanet : "") .'" />';
          ...
          <tr>
            <td colspan="12" class="datatablehead"><?php echo $rg.':'.$rp.' - '.$rname.' ('.getscannames($rscans).')'; ?></td>
                ...
                <tr>
                  ...
                  <td colspan="2">&nbsp;</td>
                  <?php
                        $gscan = 	  'Ab hier Kopieren: 00,10Geschützscan (01,10 '.$ggen.'%00,10 ) '.$rname.' (01,10'.$rg.':'.$rp.'00,10)&lt;br /&gt;';
                ...
                <tr>
                  ...
                  <td colspan="2">&nbsp;</td>
                  <?php
						$MiliH = 	  'Ab hier Kopieren: 00,10Militärscan (01,10 '.$mgen.'%00,10 ) '.$rname.' (01,10'.$rg.':'.$rp.'00,10)&lt;br /&gt;';
