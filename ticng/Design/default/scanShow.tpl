{if $scanAnzahl}
    {foreach key=key item=value from=$galaUsers}
        <a href="#{$smarty.request.gala}:{$value}" style="color: #000000;"
...
{if $sek[z1]}
    <td style="padding: 0px 5px 0pX 5px;"><table border="0">
        ...
        <tr align="left">
            <td>Scanner</td>
            <td class="bigger" {popup caption=$sekHeader[z1].scanner.text text=$sekHeader[z1].scanner.scans width="100"}>{$sekHeader[z1].scanner.text}</td>
        </tr>
        <tr align="left" class="dark">
            <td>Herkunft</td>
...
{if $gesch[z1]}
    <td style="padding: 0px 5px 0px 5px;"><table border="0">
        ...
        {foreach key=key item=value from=$geschNamen}
            <tr align="left"{php}if ($i0 % 2 != 0) { echo ' class="dark"'; } $i0++;{/php}>
                <td {popup caption=$value.1 text=$value.0 offsety="15"}>{$value.1}</td>
        ...
        <tr align="left" class="dark">
            <td>Scanner</td>
            <td class="bigger" {popup caption=$geschHeader[z1].scanner.text text=$geschHeader[z1].scanner.scans width="100"}>{$geschHeader[z1].scanner.text}</td>
        </tr>
        <tr align="left">
            <td>Herkunft</td>
...
{if $unit[z1]}
    <td style="padding: 0px 5px 0px 5px;"><table border="0">
        ...
        {foreach key=key item=value from=$schiffNamen}
            <tr align="left"{php}if ($i0 % 2 == 0) { echo ' class="dark"'; } $i0++;{/php}>
                <td {popup caption=$value.0 text=$value.1 width="100" offsety="15"}>{$value.0}</td>
        ...
        <tr align="left">
            <td>Scanner</td>
            <td class="bigger" {popup caption=$unitHeader[z1].scanner.text text=$unitHeader[z1].scanner.scans width="100"}>{$unitHeader[z1].scanner.text}</td>
        </tr>
        <tr align="left" class="dark">
            <td>Herkunft</td>
...
{if $mili[z1]}
    <td style="padding: 0px 5px 0px 5px;"><table border="0">
        ...
        <tr align="left" class="dark">
            <td>Scanner</td>
            <td colspan="3" class="bigger" {popup caption=$miliHeader[z1].scanner.text text=$miliHeader[z1].scanner.scans width="100"}>{$miliHeader[z1].scanner.text}</td>
        </tr>
        <tr align="left">
            <td>Herkunft</td>
...
{if !$oneScan}
    <div>
        {if $news[z1]}
            <a href="{$scanPfad}&scanSearch=1&gala={$scanHeader[z1].gala}&planet={$scanHeader[z1].planet}#news"
...
{if $news && $oneScan}
    <table border="0" style="padding: 10px 0px 0px 0px;" align="left">
        ...
        <tr align="left"{php}if ($i0 % 2 == 0) { echo ' class="dark"'; } $i0++;{/php}>
            <td>Scanner</td>
            <td colspan="5" class="bigger" {popup caption=$newsHeader[z1].scanner.text text=$newsHeader[z1].scanner.scans width="100"}>{$newsHeader[z1].scanner.text}</td>
        </tr>
        <tr align="left"{php}if ($i0 % 2 == 0) { echo ' class="dark"'; } $i0++;{/php}>
            <td>Herkunft</td>
