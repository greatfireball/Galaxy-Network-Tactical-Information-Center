<form action="{$scanPfad}" method="POST">
    ...
    <input type="hidden" name="scantyp" value="{$smarty.request.scantyp}" />
    {if $smarty.request.scantyp == $scans.sek}
        <table border="0">
            <tr align="middle">
    ...
    {elseif $smarty.request.scantyp == $scans.unit}
        <table border="0">
            <tr align="middle">
    ...
    {elseif $smarty.request.scantyp == $scans.mili}
        <table border="0">
            <tr align="middle">
    ...
    {elseif $smarty.request.scantyp == $scans.gesch}
        <table border="0">
            <tr align="middle">
